...
function nuevoUsuario(nombre, email, password) {
   ...
   // Retornar el objeto.
   // Tu código:
   // var objet3 = {nombre: 'edgar', email:'edgar@gmail.com', password:'1234'}
   // return objet3;
   var nuevoUsuario = {
      nombre: nombre,
      email: email,
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   objetoProducto.calcularPrecioDescuento = function(){
      return objetoProducto.precio - (objetoProducto.precio * this.porcentajeDeDescuento);
      }
